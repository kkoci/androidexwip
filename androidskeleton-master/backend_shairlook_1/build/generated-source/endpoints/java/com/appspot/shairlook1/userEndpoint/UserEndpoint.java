 ...
 * on 2015-07-19 at 05:27:10 UTC 
 * Modify at your own risk.
 */

package com.appspot.shairlook1.userEndpoint;
...
public class UserEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://shairlook1.appspot.com/_ah/api/";
   ...
   *
   * @param content the {@link com.appspot.shairlook1.userEndpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.appspot.shairlook1.userEndpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserEndpointRequest<com.appspot.shairlook1.userEndpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.appspot.shairlook1.userEndpoint.model.User content) {
      super(UserEndpoint.this, "POST", REST_PATH, content, com.appspot.shairlook1.userEndpoint.model.User.class);
    }
  ...
  public class ListUser extends UserEndpointRequest<com.appspot.shairlook1.userEndpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(UserEndpoint.this, "GET", REST_PATH, null, com.appspot.shairlook1.userEndpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.appspot.shairlook1.userEndpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserEndpointRequest<com.appspot.shairlook1.userEndpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.appspot.shairlook1.userEndpoint.model.User content) {
      super(UserEndpoint.this, "PUT", REST_PATH, content, com.appspot.shairlook1.userEndpoint.model.User.class);
    }
