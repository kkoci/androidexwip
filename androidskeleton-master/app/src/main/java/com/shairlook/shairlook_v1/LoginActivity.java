...
public class LoginActivity extends FragmentActivity implements 
	...
	*/
	 ...
	 * */
	static String TWITTER_CONSUMER_KEY = "PudaP2ewqG5RRcDmYYObjcmeW";
	static String TWITTER_CONSUMER_SECRET = "aToC8zmxCK2V5pK23uyxZmirsMHs4gt1cahumqyKGNtJWt571d"; // place your consumer secret here

	// Preference Constants
	static String PREFERENCE_NAME = "twitter_oauth";
	static final String PREF_KEY_OAUTH_TOKEN = "92343472-oJdUshaEg4KYXdGeptci5RCfnQdFRSQnZBuqd2doE";
	static final String PREF_KEY_OAUTH_SECRET = "ZcOb6Wi1yWjvnjwokpYgjEFAXG0khOIBpoJLIZ1KfcEfz";
	static final String PREF_KEY_TWITTER_LOGIN = "isTwitterLogedIn";

	static final String TWITTER_CALLBACK_URL = "oauth://www.shairlook.com/twitter/callback/";
			...
			if (responseCode == RESULT_OK) {
				...
				if (revoke == true) {
					...
					progressDialog = ProgressDialog.show(
				            LoginActivity.this, "", "Loging out...", true);
					new Request(
							   session,
							    "/me/permissions",
							    null,
		...
		btnLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if ((txtEmail.length() == 0) || (txtPassword.length() == 0)) {
					Toast.makeText(LoginActivity.this, "You need to provide values for Email and Password", Toast.LENGTH_SHORT).show();
					return;
				}
				try {
					Intent k = new Intent(LoginActivity.this, WelcomeScreen.class);
					startActivity(k);
				} catch (Exception e) {
